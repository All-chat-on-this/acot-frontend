        ...
        class x {
            ...
            _createSortedPathsRules() {
                this.sortedPathsRules = [], W.Utilities.forEachProperty(this.options.paths, (d, f) => {
                    Array.isArray(f) ? this.sortedPathsRules.push({
                        from: d,
                        to: f
            ...
            load(a, m, e, h) {
                if (/^node\|/.test(m)) {
                    let r = a.getConfig().getOptionsLiteral(),
                        s = f(a.getRecorder(), r.nodeRequire || W.global.nodeRequire), o = m.split("|"), u = null;
                    try {
                        u = s(o[1])
                    } catch (S) {
                        h(S);
            ...
            load(a, m, e, h) {
                if (/^node\|/.test(m)) {
                    const r = a.getConfig().getOptionsLiteral(),
                        s = f(a.getRecorder(), r.nodeRequire || W.global.nodeRequire), o = m.split("|");
                    let u = null;
                    try {
                        u = s(o[1])
                    } catch (S) {
        ...
        class d {
            ...
            load(a, m, e, h) {
                ...
                if (/^node\|/.test(m)) {
                    ...
                    const S = this._path.normalize(m), L = this._getElectronRendererScriptPathOrUri(S),
                        N = !!r.nodeCachedData, P = N ? this._getCachedDataPath(r.nodeCachedData, m) : void 0;
    ...
    (function (W) {
        ...
        class f {
            ...
            _loadModule(c) {
                ...
                let a = this._moduleIdProvider.getStrModuleId(c), m = this._config.moduleIdToPaths(a),
                    e = /^@[^\/]+\/[^\/]+$/;
...
//# sourceURL=${r}`, (x ? globalThis.eval(x.createScript("", o)) : new Function(o)).call(globalThis), e()
        ...
        class A {
            ...
            static fromRGBA(c) {
                const a = c.r / 255, m = c.g / 255, e = c.b / 255, h = c.a, r = Math.max(a, m, e),
                    s = Math.min(a, m, e);
                let o = 0, u = 0;
                const S = (s + r) / 2, L = r - s;
                if (L > 0) {
        ...
        class d {
            ...
            static fromRGBA(c) {
                const a = c.r / 255, m = c.g / 255, e = c.b / 255, h = Math.max(a, m, e), r = Math.min(a, m, e),
                    s = h - r, o = h === 0 ? 0 : s / h;
                let u;
...
`).trim(), B = /(file:|vscode-file:\/\/vscode-app)?(\/[^:]*:\d+:\d+)/.exec(q);
        ...
        class a {
            ...
            ComputeRecursionPoint(e, h, r, s, o, u, S) {
                ...
                const b = h - e + (s - r), g = b + 1, w = new Int32Array(g), M = new Int32Array(g), y = s - r,
                    _ = h - e, C = e - r, R = h - s, T = (_ - y) % 2 === 0;
                w[y] = e, M[_] = h, S[0] = !1;
            ...
            PrettifyChanges(e) {
                ...
                if (this._hasStrings) for (let h = 1, r = e.length; h < r; h++) {
                    const s = e[h - 1], o = e[h], u = o.originalStart - s.originalStart - s.originalLength,
                        S = s.originalStart, L = o.originalStart + o.originalLength, N = L - S, P = s.modifiedStart,
...
`).length >= 15 && r(C, D => D.length >= 2) >= 2
        ...
        class h {
            ...
            createCharSequence(v, l, b) {
                ...
                let y = 0;
                for (let _ = l; _ <= b; _++) {
                    const C = this.lines[_], R = v ? this._startColumns[_] : 1,
        ...
        class s {
            ...
            static createFromDiffChange(v, l, b) {
                const g = l.getStartLineNumber(v.originalStart), w = l.getStartColumn(v.originalStart),
                    ...
                    _ = b.getStartLineNumber(v.modifiedStart), C = b.getStartColumn(v.modifiedStart),
...
` ? new e(g) : null;
            ...
            static _doFindNextMatchLineByLine(L, N, P, E) {
                ...
                if (g) return g;
                for (let w = 1; w <= v; w++) {
                    const M = (l + w - 1) % v, y = L.getLineContent(M + 1),
            ...
            static _doFindPreviousMatchLineByLine(L, N, P, E) {
                ...
                if (g) return g;
                for (let w = 1; w <= v; w++) {
                    const M = (v + l - w - 1) % v, y = L.getLineContent(M + 1),
                ...
                for (let {range: y, text: _, eol: C} of v) {
                    ...
                    for (const O of D) {
                        const z = b.positionAt(T + O.originalStart),
                            j = b.positionAt(T + O.originalStart + O.originalLength), F = {
